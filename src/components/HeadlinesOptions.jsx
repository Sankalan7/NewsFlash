...
const HeadlinesOptions = () => {
  return (
    <ul
      ...
      className="z-50 space-x-2 absolute w-[800px] bg-gray-800 text-white left-[677px] right-0 mt-1 p-2 flex flex-wrap justify-center opacity-100 pointer-events-auto"
    >
